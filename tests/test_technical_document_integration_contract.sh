...
PY
then ok "manifest/routes 一一对应且共十六个技能"; else bad "manifest/routes 数量或对应关系错误"; fi
...
if rg -qi 'sixteen reusable cross-project Skills|sixteen.*shared skill' README.md \
  && rg -q '16 个跨项目共享 Skill|十六个跨项目共享 Skill' README.zh-CN.md \
