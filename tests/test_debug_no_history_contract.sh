...
echo "=== 3. debug 例外（真源：debug_mode.md §14 + steps/log.md + steps/00_init.md）==="
check_contains references/debug_mode.md "不参考历史工单" "debug_mode.md 有 debug 例外"
check_contains references/debug_mode.md "跳过历史工单检索" "debug_mode.md 跳过源1"
check_contains steps/log.md "跳过源1" "log.md 跳过源1"
check_contains steps/00_init.md "跳过源1" "00_init.md 跳过源1"
